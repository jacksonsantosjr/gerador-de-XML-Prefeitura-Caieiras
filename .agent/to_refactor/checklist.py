...
def run_script(name: str, script_path: Path, project_path: str, url: Optional[str] = None) -> dict:
    ...
    # Check if this script needs a URL
    script_name_lower = script_path.name.lower()
    if url and ("lighthouse" in script_name_lower or "playwright" in script_name_lower):
        cmd.append(url)
    ...
    except (subprocess.SubprocessError, IOError, Exception) as e:
