      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="flex items-center space-x-2 sm:space-x-4">
            <button className="text-stone-700 dark:text-slate-300 hover:text-stone-900 dark:hover:text-white px-3 py-2 rounded-sm text-sm font-medium transition-colors" title="Tela atual de envio de planilhas">
              Faturamento
            </button>
            <button 
              onClick={onOpenTomadores}
              className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 flex items-center space-x-1 px-3 py-2 rounded-sm text-sm font-medium transition-colors" 
              title="Visualização do seu banco de dados de clientes (Supabase)"
            >
